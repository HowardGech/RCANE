...
parser.add_argument('--save-name', type=str, help='The name of the preprocessed result ending without extension')
...
if __name__ == "__main__":
    ...
    logging.info(f'Saved preprocessed data to {args.save_dir}/{save_name}.npz. The gene names are saved to {args.save_dir}/gene_names_{save_name}.csv')
    print(f'Saved preprocessed data to {args.save_dir}/{save_name}.npz. The gene names are saved to data/gene_names_{save_name}.csv')
